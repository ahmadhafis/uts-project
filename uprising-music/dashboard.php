<?php require 'assets/templates/header.php'; ?>
        ...
        <!-- Begin Page Content -->
        <div class="container-fluid" style="background-image: url(https://objectstorage.ap-osaka-1.oraclecloud.com/n/axcdr4r17vzw/b/uts-cloud/o/assets%2Fimages%2Fawesome-feat-bg-1.png); background-size: cover; height: 90%;">
